...
@st.cache(ttl=None, show_spinner=True, suppress_st_warning=True)
...
def save_search(text_input, search_time, n_records, n_results, selected_code, collection_name, firestore_client=firestore_client):
