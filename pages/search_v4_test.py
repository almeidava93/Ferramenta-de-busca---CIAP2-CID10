...
def ciap_search():
    with st.container():
        ...
        with col2:
            n_results = st.number_input('N resultados', value = 5, min_value=1, max_value=20, step=1, key=None, help='Número de resultados mostrados')
    if input != "":
        t0 = time.time()
        ...
        save_search(input, n_records, n_results, results.iloc[0,0], collection_name='search_history')
